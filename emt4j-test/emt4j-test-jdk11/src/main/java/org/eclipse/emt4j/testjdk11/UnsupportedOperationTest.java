...
@TestConf(mode = {TestConf.ModeEnum.CLASS}, from = TestConf.RELEASE.JDK11, to = TestConf.RELEASE.JDK17)
public class UnsupportedOperationTest extends SITBaseCase {
    ...
    public void verify(JsonReport jsonReport) {
        assertTrue(matchAny(jsonReport, "UNSUPPORTED_OPERATION"));
    }
}
