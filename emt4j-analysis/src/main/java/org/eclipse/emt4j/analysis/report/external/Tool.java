...
/**
 * Define the interface integrated with external tools.
 */
public interface Tool {
    List<BodyRecord> analysis(ExternalToolParam etp, ReportConfig reportConfig, Progress parentProgress) throws IOException, InterruptedException;
