...
/**
 * when use emt4j-agent to analysis the incompatible problems. The agent writes
 * the result a single file. This file no need to be analysis again, it can be process by report directly.
 */
