...
/**
 * JDK 11 caller implementation.
 * In JDK 11,there no sun.reflect.Reflection#getCallerClass(int),but there <code>StackWalker</code>
 * can get the class of caller.
 */
public class Java11CallerProvider implements CallerProvider {
